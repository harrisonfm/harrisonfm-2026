<template>
  <nav class="nav-menu" v-if="menu">
    ...
    <button class="header-icon" @click="themeStore.toggleTheme()" type="button" aria-label="Toggle theme">
      ...
      <!-- system preference: cloud with sun/moon -->
      <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="w-6 h-6" fill="currentColor">
        <path d="M294.2 1.2c5.1 2.1 8.7 6.7 9.7 12.1l12.6 74.1 74.1 12.6c5.4 1 9.9 4.6 12.1 9.7s1.5 10.9-1.6 15.4l-43.2 57.6 8.5 57.1C239.3 232.2 176 280.7 176 344c0 9.1 1.2 18 3.4 26.5c-5.4 .9-10.9 1.5-16.4 1.5C73.1 372 0 298.9 0 208S73.1 44 163 44c30.7 0 59.4 8.6 83.9 23.6L294.2 1.2zm-42.9 97.8C231.6 88.9 198 84 163 84C95.1 84 40 139.1 40 208s55.1 124 123 124c4.1 0 8.2-.2 12.2-.6C178.7 301.4 192 271.9 192 240c0-18.2 4.5-35.4 12.4-50.5l-9-15.6c-3.4-5.9-3.2-13.2 .6-18.9l55.4-55.9zM448 320a128 128 0 1 1 0 256 128 128 0 1 1 0-256zm0 208a80 80 0 1 0 0-160 80 80 0 1 0 0 160z"/>
      </svg>
    </button>
  </nav>
</template>
